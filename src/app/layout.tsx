...
export const metadata: Metadata = {
  title: "Bella Vista - Authentic Italian Restaurant | Traditional Cuisine",
  description: "Experience authentic Italian dining at Bella Vista. Traditional recipes, fresh ingredients, and warm hospitality since 1985. Reserve your table today.",
  keywords: "italian restaurant, authentic italian food, traditional recipes, pasta, pizza, reservations, fine dining",
  metadataBase: new URL("https://bellavista.com"),
  alternates: {
    canonical: "https://bellavista.com"
  },
  openGraph: {
    title: "Bella Vista - Authentic Italian Restaurant",
    description: "Experience authentic Italian dining with traditional recipes and warm hospitality since 1985.",
    url: "https://bellavista.com",
    siteName: "Bella Vista Italian Restaurant",
    images: [
      {
